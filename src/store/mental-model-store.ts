...
function defaultNodes(): MentalModelNode[] {
  return [
    ...
    },
    {
      ...
      tags: ['ui', 'dark-mode'], confidence: 'low', source: 'observed',
      createdAt: daysAgo(120), updatedAt: daysAgo(120), linkedIds: [],
      active: true, pinned: false, memoryType: 'semantic', scope: 'Personal', importance: 0.25,
    ...
    },
    {
      ...
      tags: ['coffee', 'morning', 'routine'], confidence: 'medium', source: 'conversation',
      createdAt: daysAgo(75), updatedAt: daysAgo(75), linkedIds: ['dn-fact-morning'],
      active: true, pinned: false, memoryType: 'semantic', scope: 'Personal', importance: 0.4,
